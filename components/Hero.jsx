            ...
            <div className="flex items-center justify-between">
                ...
                <div className="w-full xl:max-w-[580px] md:h-[820px] flex flex-col justify-center items-start">
                    ...
                    <p className="mb-10 text-lg max-w-[508px] mx-auto text-center xl:text-left xl:mx-0">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic quae corrupti amet aut accusantium consequuntur perspiciatis, minus libero unde ab reprehenderit quos numquam vero minima quasi eligendi dolores omnis officia.
                    </p>
                    {/* btn group */}
