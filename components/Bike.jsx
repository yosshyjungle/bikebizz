  ...
  return (
    <div className='group'>
        <div className='border h-[328px] mb-5 p-4 overflow-hidden relative'>
            ...
            {/* btn group */}
            <div className='absolute top-0 left-0 right-0 bottom-0 justify-center items-center gap-[10px] opacity-0 group-hover:opacity-100 transition-all duration-300'>
                <AddToCartBtn
        ...
        <h4 className='text-lg font-bold text-accent'>$ {bike.price}</h4>
